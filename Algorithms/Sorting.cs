...
namespace Algorithms
{
    ...
    public static class Sorting
    {
        ...
        ///     <strong>first</strong>, <strong>second</strong>, or <strong>third</strong> are
        ///     <strong>null</strong>.
        /// </exception>
        ...
        public static IList<string> RadixSort(this IList<string> list, int keySize)
        {
            ...
            var partiallySorted = new string[listCount]; // used for partial sort
            const int Radix = 256; // 256 is number of ASCII chars

            for (int d = keySize - 1; d >= 0; d--)
            {
                var count = new int[Radix]; // used for ascii char count
        ...
        private static IList<T> MergeSortInternal<T>(IList<T> list)
        {
            ...
            var right = new T[list.Count - middle];
